# -*- coding: utf-8 -*-
"""
Created on Thu Oct 24 21:53:19 2019
...
def metodo_Jacobi(A, B, vector_solucion, tolerancia):
        ...
        while(abs(error_max_k) > tolerancia or iteracion_k == 0):
            ...
            for i in range(len(vector_solucion)):
                ...
                for j in range(len(vector_aux)):
                    if(j != i):
                        sumatorio += A[i][j]*vector_aux[j]
                #Ahora calculamos el numerador
                numerador = B[i] - sumatorio
...
if __name__ == "__main__":
    ...
    v_sol = metodo_Jacobi(A, B, v, tolerancia)